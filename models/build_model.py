...
def create_model(img_size, n_classes, args):
    ...
    if args.model == "vit":
        ...
        model = cait_models(
        img_size= img_size,patch_size=patch_size, embed_dim=192, depth=args.depth, num_heads=args.heads, mlp_ratio=args.vit_mlp_ratio
        , qkv_bias=True,num_classes=0,drop_path_rate=args.sd,norm_layer=partial(nn.LayerNorm, eps=1e-6),
